import MyImg from "./media/logo.png"
function Navbar() {
    return (
        <div className="fixed-top">
            ...
            <nav className="navbar navbar-expand-lg bg-light navbar-specs">
                ...
                <img src={MyImg} className="rounded-circle my-auto nav-image mx-2" alt="Abhinav Agrawal" />
                    <a className="navbar-brand fw-bold color-text me-auto" href="/">Abhinav Agrawal</a>
